...
For these exercises, we are going to use one of the versions of the "Lalonde data," which is used in almost every paper on matching.^[Lalonde, R. (1986). "Evaluating the econometric evaluations of training programs with experimental data." _American Economic Review_ 76: 604-620.] This is data on a job training program (the treatment) that was intended to raise future earnings (the outcome).
...
```
131 cases are dropped. However, my output is not telling me how many cases of this are from the treated group.\
